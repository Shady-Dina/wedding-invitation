...
function renderMessages(messages) {
  ...
  if (messages.length === 0) {
    ...
    const emptyText = currentLang === "ar" 
      ? "لسه مفيش تهاني أو تعليقات. ابدأ أنت واكتب أول رسالة ودعوة حلوة للعروسين شادي ودينا! ♥"
      : "No wishes yet. Be the first to send your blessing to Shady & Dina! ♥";
    ...
    try {
      ...
      if (typeof Swal !== "undefined") {
        Swal.fire({
          ...
          text: currentLang === "ar" ? "تم إضافة رسالتك الجميلة لدفتر زوار شادي ودينا.. شكراً لمشاعرك الطيبة ♥" : "Your heartfelt wish has been added to Shady & Dina's real-time guestbook.",
          icon: "success",
